...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Update category information to organize your content</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="slug" id="slug" value="{{ old('slug', $category->slug) }}" class="w-full px-4 py-2 border rounded-lg">
                        </div>
                        <div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="meta_title" value="{{ old('meta_title', $category->meta_title) }}" class="w-full px-4 py-2 border rounded-lg">
                        </div>
                        <div>
                            <label class="block text-sm font-medium mb-2">Meta Description</label>
                            <textarea name="meta_description" rows="3" class="w-full px-4 py-2 border rounded-lg">{{ old('meta_description', $category->meta_description) }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium mb-2">Meta Keywords</label>
                            <input type="text" name="meta_keywords" value="{{ old('meta_keywords', $category->meta_keywords) }}" class="w-full px-4 py-2 border rounded-lg">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6">
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <button type="submit" class="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg">Update Category</button>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="mb-3 text-center">
                        <img src="{{ Storage::url($category->icon) }}" class="w-20 h-20 mx-auto rounded border">
                        <p class="text-xs text-gray-500 mt-2">Current Icon</p>
                    </div>
                    @endif
                    ...
                    <label for="icon" class="block border-2 border-dashed rounded-lg p-4 text-center cursor-pointer hover:bg-gray-50">
                        ...
                        <div id="icon-placeholder"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg><p class="text-sm text-gray-500 mt-2">Upload New Icon</p></div>
                    </label>
                </div>

                <div class="bg-white rounded-lg shadow-sm p-6">
                    <h3 class="text-lg font-semibold mb-4">Color</h3>
                    <input type="color" name="color" id="color" value="{{ old('color', $category->color ?? '#3B82F6') }}" class="w-full h-10 border rounded cursor-pointer">
                </div>
            </div>
        </div>
    </form>
