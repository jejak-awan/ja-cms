...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Create New Permission</h2>
            <p class="text-sm text-gray-600 mt-1">Create a new system permission</p>
        </div>
    ...
    <form method="POST" action="{{ route('admin.permissions.store') }}" class="space-y-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select id="group" name="group" 
                        ...
                        @endforeach
                        <option value="custom" {{ old('group') == 'custom' ? 'selected' : '' }}>Custom Group</option>
                    </select>
        ...
        <div class="bg-blue-50 rounded-lg p-6">
            <h4 class="text-md font-medium text-blue-900 mb-3">Permission Examples</h4>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                    <h5 class="font-medium text-blue-800 mb-2">Content Management</h5>
                    <ul class="space-y-1 text-blue-700">
                        <li>• manage_articles</li>
                        <li>• manage_pages</li>
                ...
                <div>
                    <h5 class="font-medium text-blue-800 mb-2">User Management</h5>
                    <ul class="space-y-1 text-blue-700">
                        <li>• manage_users</li>
                        <li>• manage_roles</li>
                        <li>• manage_permissions</li>
                        <li>• view_user_activity</li>
                    </ul>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    nameInput.addEventListener('input', function() {
        if (!displayNameInput.value || displayNameInput.value === old('display_name')) {
