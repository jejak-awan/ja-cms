...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Create New Article</h2>
            <p class="text-sm text-gray-600 mt-1">Write and publish a new blog post</p>
        </div>
