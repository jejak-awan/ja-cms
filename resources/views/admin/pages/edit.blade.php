...
<div class="space-y-6">
    <x-admin.page-header
        :title="__('admin.pages.edit_page')"
        :subtitle="__('admin.pages.edit_subtitle')"
    >
        <x-slot name="actions">
            <x-admin.button 
                type="link" 
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                    <x-admin.input-field
                        ...
                        type="text"
                        :value="old('title_' . app()->getLocale(), $page->title)"
                        required
                ...
                @include('admin.pages.includes.seo-section', ['page' => $page])
            </div>

            <div class="space-y-6">
                @include('admin.pages.includes.publish-settings', ['page' => $page])

                @include('admin.pages.includes.template-selection', ['templates' => $templates, 'page' => $page])

                @include('admin.pages.includes.featured-image', ['page' => $page])
            </div>
        </div>
    </form>
</div>
