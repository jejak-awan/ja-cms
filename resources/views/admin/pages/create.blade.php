...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Add a new static page</p>
        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="flex items-center">
                                <input type="checkbox" name="is_homepage" value="1" {{ old('is_homepage') ? 'checked' : '' }} class="rounded">
                                <span class="ml-2 text-sm">Set as Homepage</span>
                            </label>
                        </div>
                    </div>
                    <button type="submit" class="w-full mt-4 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg">Create Page</button>
                </div>
